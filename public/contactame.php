...
<html lang="en">
    <head>
        ...
        <meta name="description" content="¡Hola! Soy Casha, y estoy aquí para ayudarte con tu proyecto digital. Ponte en contacto conmigo y hablemos de cómo puedo contribuir a tu éxito en el mundo digital.">
        ...
        <title> casha | Hablemos de tu proyecto digital </title>
    </head>
    <body>
        <!-- Navbar -->
        <header>
                                ...
                                <div class="col-auto align-items-center">
                                    <div class="dropdown dropup">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="languageDropdown">
                                            <li>
                                                <a class="dropdown-item text-end" style="color: #0C141D;" href="/pages/contactame.html">
                                                    Español
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item text-end" style="color: #0C141D;" href="/pages/contact.html">
                                                    English
                                                </a>
                                            </li>
                                        </ul>
        ...
        <main>
            <!-- Contacto -->
            <section class="py-3 py-md-5 mt-5 contactoContainer">
                <div class="container">
                    <!-- Titulo & Descripción -->
                  <div class="row justify-content-md-center">
                    <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-9 mt-5">
                        <h1 class="display-5 fw-bold mt-5 mb-4 text-uppercase text-center">
                        ...
                        <p class="fs-4 mb-5 text-center">
                            Ya sea que necesites ayuda con el <strong>diseño de tu sitio web, estrategias de marketing o mejorar la experiencia de usuario</strong>, estoy aquí para ayudarte a <strong>alcanzar tus objetivos</strong>.
                        </p>
                ...
                <!-- Forma de contacto -->
                <div class="container mb-5 align-items-stretch">
                    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-xl-center">
                        <div class="col-12 col-lg-6 formContainer d-flex align-items-stretch">
                            <img class="img-fluid rounded" loading="lazy" src="/images/contact-us.png" alt="Imagen de una construcción hecha con legos, simbolizando la edificación de tus objetivos digitales.">
                        </div>
                        <div class="col-12 col-lg-6 formContainer d-flex align-items-stretch">
