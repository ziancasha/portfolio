...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Descubre cómo transformamos el sitio web de GCSS mediante un rediseño integral, junto con una estratégica campaña de branding en redes sociales, siendo LinkedIn la principal. Este caso de estudio revela cómo nuestra intervención creó una sólida presencia online y generó resultados tangibles para GCSS. ¡Explora el proceso y los resultados ahora!">
        ...
        <title> casha | GCSS - Rediseño Sitio Web & Branding </title>
    </head>
    <body>
        <!-- Navbar -->
        <header>
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                        ...
                        <div class="offcanvas-body menu-container">
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <!-- Proyectos -->
                                <li class="nav-item">
                                    <a class="menu-text d-flex align-items-center justify-content-start" href="proyectos.html">
                                ...
                                <!-- Conóceme -->
                                <li class="nav-item">
                                    <a class="menu-text d-flex align-items-center justify-content-start" href="conoceme.html">
                                ...
                                <div class="col-auto align-items-center">
                                    <div class="dropdown dropup">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="languageDropdown">
                                            <li>
                                                <a class="dropdown-item text-end" style="color: #0C141D;" href="gcss.html">
                                                    Español
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item text-end" style="color: #0C141D;" href="#">
                                                    English
                                                </a>
                                            </li>
                                        </ul>
